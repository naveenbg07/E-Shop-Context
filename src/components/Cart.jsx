...
function Cart() {
  ...
  //delete itm
  const delItem = (id) => {
    if(window.confirm('Do you want remove product..?')){
       ...
       <div className="row">
        ...
        <div className="row">
          <div className="col-md-8 col-lg-9 col-sm-12">
            <table className="table table-boarded table-striped table-hover">
            ...
            <div col-md-4 className="col-lg-3 col-sm-12">
              <div className="card">
                ...
                <button className='btn btn-outline-success float-center'>Check Out</button>
              </div>
            </div>
          </div>
        </div> 
